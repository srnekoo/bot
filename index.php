<?php
   ...
   $_SESSION['scriptcase']['blank']['glo_nm_conexao']         = "conn_mysql";
...
//
   function init($Tp_init = "")
   {
      ...
      $this->nm_dt_criacao   = "20220304"; 
      $this->nm_hr_criacao   = "203123"; 
      $this->nm_autor_alt    = "admin"; 
      $this->nm_dt_ult_alt   = "20220307"; 
      $this->nm_hr_ult_alt   = "143453"; 
...
// 
      ...
      $_SESSION['scriptcase']['nm_bases_security']  = "enc_nm_enc_";
      $this->prep_conect();
      $this->conectDB();
...
<?php
   ...
   function conectDB()
   {
      ...
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['blank']['glo_nm_conexao'], $this->root . $this->path_prod, 'project1', 1, $this->force_db_utf8); 
      } 
      else 
      { 
          ob_start();
...
curl_setopt_array($curl, array(
  CURLOPT_URL => 'https://webhookluaa.herokuapp.com/index.php',
...
function envia_mensagem($phone, $message)
{
$_SESSION['scriptcase']['blank']['contr_erro'] = 'on';
...
function salva_historico($phone, $talento, $integrantes, $dia, $hora, $instagram, $code)
{
$_SESSION['scriptcase']['blank']['contr_erro'] = 'on';
...
//======= =========================
   ...
   if ($Sem_Session && (!isset($nmgp_start) || $nmgp_start != "SC")) {
       ...
       elseif (is_file($root . $_SESSION['scriptcase']['blank']['glo_nm_path_imag_temp'] . "/sc_apl_default_project1.txt")) {
           $apl_def = explode(",", file_get_contents($root . $_SESSION['scriptcase']['blank']['glo_nm_path_imag_temp'] . "/sc_apl_default_project1.txt"));
       }
       if (isset($apl_def)) {
           if ($apl_def[0] != "blank") {
           ...
           if (isset($_COOKIE['sc_actual_lang_project1'])) {
               $_SESSION['scriptcase']['blank']['session_timeout']['lang'] = $_COOKIE['sc_actual_lang_project1'];
           }
       }
   }
